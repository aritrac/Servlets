...
public class AboutUsPageHandler {
	// REQUEST AND RESPONSE OBJECTS
		...
		public AboutUsPageHandler(HttpServletRequest request,
		...
		public void doShow() throws IOException {
			...
			if(page.equalsIgnoreCase("adminfilespage")){
				AdminFilesPageHandler afpHanlder = new AdminFilesPageHandler(request, response);
				afpHanlder.show();
			}
		...
		public void show() throws IOException {
			...
			response.sendRedirect("JSPs/about_page.jsp");
		}
